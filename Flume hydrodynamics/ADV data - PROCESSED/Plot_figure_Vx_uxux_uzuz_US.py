...
# Import data V1 -------------------------------------------------------------
# Mean vel data
Z1 = np.loadtxt('Upstream//Upstream_V1_Z.txt')
Vxm1 = np.loadtxt('Upstream//Upstream_V1_Vxm.txt')
[ushear_logwakelaw1,ushear_uxuz1] = np.loadtxt('Upstream//Upstream_V1_ushear.txt')
[delta_logwakelaw1,delta_uxuz1] = np.loadtxt('Upstream//Upstream_V1_delta.txt')
[q1,Hmax1,ks1,ufs1,PI1] = np.loadtxt('Upstream//Upstream_V1_q_Hmax_ks_ufs_PI.txt')
# uxuxn
vxvxn1 = np.loadtxt('Upstream//Upstream_V1_vxvxn.txt')
vzvzn1 = np.loadtxt('Upstream//Upstream_V1_vzvzn.txt')

# Import data V2 -------------------------------------------------------------
# Mean vel data
Z2 = np.loadtxt('Upstream//Upstream_V2_Z.txt')
Vxm2 = np.loadtxt('Upstream//Upstream_V2_Vxm.txt')
[ushear_logwakelaw2,ushear_uxuz2] = np.loadtxt('Upstream//Upstream_V2_ushear.txt')
[delta_logwakelaw2,delta_uxuz2] = np.loadtxt('Upstream//Upstream_V2_delta.txt')
[q2,Hmax2,ks2,ufs2,PI2] = np.loadtxt('Upstream//Upstream_V2_q_Hmax_ks_ufs_PI.txt')
# uxuxn
vxvxn2 = np.loadtxt('Upstream//Upstream_V2_vxvxn.txt')
vzvzn2 = np.loadtxt('Upstream//Upstream_V2_vzvzn.txt')

# Import data V3 -------------------------------------------------------------
# Mean vel data
Z3 = np.loadtxt('Upstream//Upstream_V3_Z.txt')
Vxm3 = np.loadtxt('Upstream//Upstream_V3_Vxm.txt')
[ushear_logwakelaw3,ushear_uxuz3] = np.loadtxt('Upstream//Upstream_V3_ushear.txt')
[delta_logwakelaw3,delta_uxuz3] = np.loadtxt('Upstream//Upstream_V3_delta.txt')
[q3,Hmax3,ks3,ufs3,PI3] = np.loadtxt('Upstream//Upstream_V3_q_Hmax_ks_ufs_PI.txt')
# uxuxn
vxvxn3 = np.loadtxt('Upstream//Upstream_V3_vxvxn.txt')
vzvzn3 = np.loadtxt('Upstream//Upstream_V3_vzvzn.txt')

# Import data V4 -------------------------------------------------------------
# Mean vel data
Z4 = np.loadtxt('Upstream//Upstream_V4_Z.txt')
Vxm4 = np.loadtxt('Upstream//Upstream_V4_Vxm.txt')
[ushear_logwakelaw4,ushear_uxuz4] = np.loadtxt('Upstream//Upstream_V4_ushear.txt')
[delta_logwakelaw4,delta_uxuz4] = np.loadtxt('Upstream//Upstream_V4_delta.txt')
[q4,Hmax4,ks4,ufs4,PI4] = np.loadtxt('Upstream//Upstream_V4_q_Hmax_ks_ufs_PI.txt')
# uxuxn
vxvxn4 = np.loadtxt('Upstream//Upstream_V4_vxvxn.txt')
vzvzn4 = np.loadtxt('Upstream//Upstream_V4_vzvzn.txt')

# Import data V5 -------------------------------------------------------------
# Mean vel data
Z5 = np.loadtxt('Upstream//Upstream_V5_Z.txt')
Vxm5 = np.loadtxt('Upstream//Upstream_V5_Vxm.txt')
[ushear_logwakelaw5,ushear_uxuz5] = np.loadtxt('Upstream//Upstream_V5_ushear.txt')
[delta_logwakelaw5,delta_uxuz5] = np.loadtxt('Upstream//Upstream_V5_delta.txt')
[q5,Hmax5,ks5,ufs5,PI5] = np.loadtxt('Upstream//Upstream_V5_q_Hmax_ks_ufs_PI.txt')
# uxuxn
vxvxn5 = np.loadtxt('Upstream//Upstream_V5_vxvxn.txt')
vzvzn5 = np.loadtxt('Upstream//Upstream_V5_vzvzn.txt')
...
axs[0].set_xlabel('$u^+$ (-)')
axs[0].set_ylabel('$z^+$ (-)')
axs[0].text(4, 10000,"D",verticalalignment='center',weight='bold')
...
#axs[1].semilogx()
axs[1].text(0.5, 2.85,"E",verticalalignment='center',weight='bold')
...
axs[2].text(0.15, 2.85,"F",verticalalignment='center',weight='bold')
...
plt.savefig('Vx_uxux_uzuz_upstream.pdf', dpi=600, format='pdf',  bbox_inches='tight')
plt.savefig('Vx_uxux_uzuz_upstream.svg', dpi=600, format='svg',  bbox_inches='tight')
plt.savefig('Vx_uxux_uzuz_upstream.png', dpi=600, format='png',  bbox_inches='tight')
plt.show()